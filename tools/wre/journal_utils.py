...
from tools.wre.logging_utils import sanitize_for_console
...
def log_dialogue(speaker: str, text: str):
    ...
    Args:
        speaker (str): The speaker of the text ('O12' or 'O1O2').
...
if __name__ == '__main__':
    ...
    parser.add_argument("speaker", type=str, choices=['O12', 'O1O2'], help="The speaker.")
