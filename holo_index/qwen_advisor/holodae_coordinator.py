...
class HoloDAECoordinator:
    ...
    # =========================================================================
    # PID DETECTIVE - Delegated to services/pid_detective.py (Sprint H1)
    # WSP 62: Extracted ~430 lines to maintain modularity
    # =========================================================================

    def check_pid_health(self) -> List[str]:
        """Quick health check for HoloDAE processes - delegates to PIDDetective."""
        return self.pid_detective.check_pid_health()

    def _identify_holodae_instance_type(self, cmdline: str, name: str, pid: int) -> str:
        """Identify HoloDAE process type - delegates to PIDDetective."""
        return self.pid_detective._identify_holodae_instance_type(cmdline, name, pid)

    def _get_process_details(self, pid: int) -> Dict[str, Any]:
        """Get process details - delegates to PIDDetective."""
        return self.pid_detective.get_process_details(pid)

    def show_pid_detective(self) -> None:
        """Show PID Detective interactive menu - delegates to PIDDetective."""
        self.pid_detective.show_pid_detective()

    # =========================================================================
    # MCP INTEGRATION (Next: Sprint H2)
    # =========================================================================
    # NOTE: ~280 lines of dead show_pid_detective code removed here (Sprint H1)
    # See services/pid_detective.py for the extracted implementation
    # =========================================================================

    # =========================================================================
    # WSP 62 Sprint H1: PID Detective extracted to services/pid_detective.py
    # Removed ~280 lines of dead code that remained after partial edits.
    # =========================================================================
