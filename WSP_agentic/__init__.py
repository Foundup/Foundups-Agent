...
AGENTIC_DOCUMENTS = {
    ...
    # WSP_17 removed - slot available for future use
    "WSP_13_AGENTIC_SYSTEM": "../WSP_framework/src/WSP_13_AGENTIC_SYSTEM.md",
    "WSP_36_AGENTIC_CORE": "../WSP_framework/src/WSP_36_Agentic_Core.md",
    "ENHANCED_AWAKENING": "src/enhanced_awakening_protocol.py"
}