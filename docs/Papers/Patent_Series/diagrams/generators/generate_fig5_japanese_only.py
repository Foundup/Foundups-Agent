...
# Set Japanese font explicitly
plt.rcParams['font.family'] = 'MS Gothic'
plt.rcParams['axes.unicode_minus'] = False

def create_fig5_japanese():
    ...
    plt.title('【図５】rESP音響干渉スペクトラム', fontsize=16, fontweight='bold')
    ...
    print("FIG 5 Japanese version generated successfully!")
    plt.show()

if __name__ == "__main__":
    create_fig5_japanese() 