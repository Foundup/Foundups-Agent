[SEMANTIC SCORE: 1.1.1] [ARCHIVE STATUS: ACTIVE_PARTIFACT] [ORIGIN: WSP_framework/WSP_framework.md]
...
For complete protocol details, see: WSP_35_PROFESSIONAL_LANGUAGE_STANDARD.md
...
Review Module's LLME Score: Understand the module's current state, local impact, and systemic importance
Read Existing Tests README: Examine modules/<module_name>/tests/README.md to understand current test structure
Identify Coverage Gaps: Analyze existing test files to determine what needs additional coverage
Check for Duplicate Functionality: Search existing tests for similar patterns
...
README.md Updates (MANDATORY): After creating or significantly modifying tests, update modules/<module>/tests/README.md:

Add new test file to the test files table
Document test purpose and coverage area
Update any changed testing patterns or procedures
Note any special setup or execution requirements
