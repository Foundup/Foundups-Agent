# MODULE_PLACEMENT_GUIDE (Derived Annex)

- **Type**: Non-canonical operator guide
- **Canonical Sources**:
  - `WSP_framework/src/WSP_3_Enterprise_Domain_Organization.md`
  - `WSP_framework/src/WSP_49_Module_Directory_Structure_Standardization_Protocol.md`
- **Last Synced**: 2026-02-12
- **Edit Rule**: Canonical WSP governs; this file is a convenience view
