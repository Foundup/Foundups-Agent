# MODULE_DECISION_MATRIX (Derived Annex)

- **Type**: Non-canonical quick reference
- **Canonical Sources**:
  - `WSP_framework/src/WSP_3_Enterprise_Domain_Organization.md` (Domain routing)
  - `WSP_framework/src/WSP_49_Module_Directory_Structure_Standardization_Protocol.md` (Structure sanity gates)
- **Last Synced**: 2026-02-12
- **Edit Rule**: Update canonical WSP first, then resync this annex
