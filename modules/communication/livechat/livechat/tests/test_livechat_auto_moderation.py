...
class TestLiveChatAutoModerationIntegration:
    ...
    def setup_method(self):
        ...
        with patch('modules.communication.livechat.livechat.src.livechat.BanterEngine'), \
             patch('modules.communication.livechat.livechat.src.livechat.LLMBypassEngine'), \
             patch('modules.communication.livechat.livechat.src.livechat.AutoModerator') as mock_auto_mod:
