...
print("\n" + "="*80)
print("🎬 GENERATE FIRST YOUTUBE SHORT WITH TALKING BABY")
print("="*80)
...
try:
    ...
    print("✅ SUCCESS!")
    print("="*80)
    print(f"\n🎬 Your first AI-generated talking baby Short is live!")
    print(f"\n🔗 Watch here: {shorts_url}")
    print(f"\n📊 Details:")
    ...
    print()
    print(f"🎉 Next: Change privacy to 'public' to share with the world!")
    print()
