# Move2Japan YouTube Shorts - Style Guide

**Channel**: Move2Japan
**Target Audience**: Japan enthusiasts, expats, travelers, culture lovers
**Tone**: Fun, cheeky, authentic, surprising
**Duration**: 15-30 seconds (Shorts format)
...
1. **Fun & Playful**: Like a knowledgeable friend who's lived in Japan
2. **Cheeky**: Gentle humor, cultural observations, surprising twists
3. **Baby-Talking**: Cute, endearing, accessible (kawaii culture)
4. **Authentic**: Real Japan, not stereotypes
5. **Surprising**: "Wait, that's a thing in Japan?!"
...
- **Golden Hour**: Warm, inviting lighting
- **Dynamic**: Slow pans, reveals, smooth movements
- **POV Focus**: First-person perspective when possible
- **Cultural Details**: Close-ups on uniquely Japanese elements

### Pacing
- **Hook (0-2s)**: Immediate visual grab
- **Reveal (3-8s)**: Show the "what"
- **Context (9-12s)**: Brief explanation/reaction
- **Payoff (13-15s)**: Satisfying conclusion
...
- **Language**: "Ooh!", "Wait, what?", "No way!"
- **Visual**: Discovery moments, reveals

### The Cozy Comfort Seeker
- **Tone**: Warm, comforting, satisfied
- **Language**: "Ahhh", "Perfect", "This is the life"
- **Visual**: Comfort foods, warm spaces, peaceful moments

### The Cheeky Local
- **Tone**: In-the-know, playful secrets
- **Language**: "Only locals know...", "Pro tip:", "Secret spot!"
- **Visual**: Hidden places, insider knowledge

### The Culture Appreciator
- **Tone**: Respectful awe, genuine appreciation
- **Language**: "Beautiful", "Amazing", "Incredible"
- **Visual**: Traditional crafts, ceremonies, art
...
2. **Challenge**: "Try not to get hungry watching this..."
3. **Secret**: "Locals hide this spot from tourists..."
4. **POV**: "POV: Your first time seeing..."
5. **Question**: "Ever wonder why Japan has..."

### Emotional Triggers
- **Nostalgia**: "Remember that feeling when..."
- **FOMO**: "This is why everyone wants to..."
- **Satisfaction**: "The most satisfying thing in Japan..."
- **Curiosity**: "I didn't know Japan had..."
- **Delight**: "The cutest thing you'll see today..."
...
- **Cultural**: Temple bells, train announcements, festival music
- **Food**: Sizzling, slurping, pouring
- **Urban**: Vending machines, crosswalk beeps, arcade sounds

### Music Style (if applicable)
- **Modern**: Lo-fi beats, chill hip-hop
- **Traditional**: Shamisen, koto, taiko drums (subtle)
- **Hybrid**: Electronic + traditional instruments
...
```
Early morning mist rises over a traditional ryokan garden in Hakone, camera
glides over perfectly raked gravel patterns and moss-covered stones, a koi
fish creates ripples in the pond, Mount Fuji appears through the mist in
perfect symmetry, soft golden sunrise light bathes everything in warmth
```
...
```
A tired salary worker drops coins into a late-night vending machine, camera
zooms to show the incredible variety: hot corn soup, iced coffee, energy drinks,
even hot noodles, a warm can clanks down, steam rises when opened, the person's
face lights up with simple joy, Tokyo skyline glows softly behind them
```
...
2. **Saves**: "I want to go here" reactions
3. **Shares**: "You need to see this" factor
4. **Comments**: Questions about visiting/moving
...
- [ ] Camera movement described (pan, zoom, reveal)
- [ ] Lighting specified (golden hour, neon, soft)
- [ ] Cultural element included (food, tradition, urban life)
- [ ] Emotional payoff present (wonder, satisfaction, joy)
- [ ] Human element or POV (relatable protagonist)
- [ ] Sensory detail (steam, rain, glow, sound)
- [ ] Surprising or delightful moment
- [ ] Authentic (not stereotypical) Japan
- [ ] Engaging for non-Japan experts too
