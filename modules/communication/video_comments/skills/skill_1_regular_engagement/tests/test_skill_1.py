...
from modules.communication.video_comments.skills.skill_1_regular_engagement.executor import (
...
def test_llm_reply_strategy():
    ...
    context = SkillContext(
        ...
        confidence=0.5,
        llm_reply="Haha yeah! The choreography is fire! 🔥"  # Pre-generated by caller
    )
...
def test_strategy_priority():
    ...
    print("[TEST] LLM strategy priority: ✓")
    ...
    print("[TEST] Template fallback priority: ✓")
...
def run_all_tests():
    ...
    if failed == 0:
        print("\n✅ ALL TESTS PASSED - Skill 1 ready for integration!")
        return True
    else:
