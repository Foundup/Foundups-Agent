...
def to_simulator_config(bundle: ParameterBundle) -> SimulatorConfig:
    ...
    return SimulatorConfig(
        ...
        layer_d_anchor_enabled=bool(p.get("layer_d_anchor_enabled", 0)),
        layer_d_anchor_every_n_epochs=p.get("layer_d_anchor_every_n_epochs", 1),
        layer_d_anchor_force_republish=bool(p.get("layer_d_anchor_force_republish", 0)),
        layer_d_anchor_mode=str(p.get("layer_d_anchor_mode", "mock")),
        layer_d_anchor_db_path=p.get("layer_d_anchor_db_path"),
