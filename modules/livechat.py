...
class LiveChatListener:
    ...
    def _handle_auth_error(self, error):
        ...
        if isinstance(error, googleapiclient.errors.HttpError):
            if error.resp.status in [401, 403]:  # Authentication errors
                ...
                new_token_index = token_manager.rotate_tokens()
    ...
    def _poll_chat_messages(self):
        ...
        try:
            ...
            if self._handle_auth_error(e):
                return self._poll_chat_messages()  # Retry with new token
    ...
    def send_chat_message(self, message_text):
        ...
        try:
            ...
            if self._handle_auth_error(e):
                return self.send_chat_message(message_text)  # Retry with new token
            return False
        except Exception as e:
