...
```bash
python modules/wre_core/run_wre.py interactive
```
...
✁E**WSP 3**: Correct module organization (single wre_core in infrastructure)
✁E**WSP 46**: WRE Protocol with DAE architecture
✁E**WSP 54**: DAE operations (agents as sub-components)
✁E**WSP 48**: Recursive self-improvement
✁E**WSP 75**: Token-based measurements (no time!)
✁E**WSP 80**: Cube-level DAE orchestration
✁E**WSP 64**: Violation prevention built-in
...
python modules/wre_core/wre_sdk_implementation.py cli
```
