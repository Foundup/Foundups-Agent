...
from modules.wre_core.dae_cube_assembly.src.dae_cube_assembler import DAECubeAssembler
from modules.wre_core.recursive_improvement.src.recursive_engine import RecursiveLearningEngine as RecursiveEngine
...
class WRESDK:
    ...
    def validate(self, action: Dict[str, Any], wsp: str = "all") -> bool:
        ...
        if violations:
            print(f"❁EValidation failed: {violations}")
            return False
        
        print("✁EWSP validation passed")
        return True
