...
def safe_log(message, level="INFO"):
    ...
    safe_message = message.replace("笶・, "[ERROR]")
    safe_message = safe_message.replace("笨・, "[OK]")
    safe_message = safe_message.replace("劇", "[WSP]")
    safe_message = safe_message.replace("噫", "[WRE]")
    safe_message = safe_message.replace("導", "[PHASE1]")
    safe_message = safe_message.replace("牒", "[PHASE8]")
    safe_message = safe_message.replace("女・・, "[PHASE7]")
    safe_message = safe_message.replace("剥", "[PHASE4]")
    safe_message = safe_message.replace("投", "[PHASE3]")
    safe_message = safe_message.replace("ｧｪ", "[PHASE10]")
    safe_message = safe_message.replace("答", "[PHASE11]")
    safe_message = safe_message.replace("売", "[PHASE12]")
