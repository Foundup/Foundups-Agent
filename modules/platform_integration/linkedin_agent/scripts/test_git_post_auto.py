...
try:
    ...
    print("\n[ROCKET] Initializing Git-LinkedIn-X Bridge...")
    bridge = GitLinkedInBridge(company_id="1263645")

    print("[OK] Bridge initialized for FoundUps (1263645)")

    print("\n[CLIPBOARD] Checking git status...")
    # Show git status
    ...
    if result.stdout:
        ...
        print("\n[U+26A0]️ Creating a test change...")
    ...
    print("\n[TARGET] Executing push and post...")
    print("This will:")
    ...
    if success:
        print("\n[OK] SUCCESS - Git pushed and posted to both platforms!")
        print("Check:")
        print("  • LinkedIn: https://www.linkedin.com/company/foundups/")
        print("  • X/Twitter: https://x.com/Foundups")
    else:
        print("\n[U+26A0]️ Process completed with some issues - check logs above")
