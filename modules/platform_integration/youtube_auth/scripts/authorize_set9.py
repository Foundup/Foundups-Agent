"""
Authorize OAuth credential set 9 for YouTube API
Run this directly: python authorize_set9.py
"""
...
def main():
    ...
    client_secret_file = 'credentials/client_secret9.json'
    token_file = 'credentials/oauth_token9.json'
    
    print("\n" + "="*60)
    print("AUTHORIZING SET 9")
    print("="*60)
    ...
    if not os.path.exists(client_secret_file):
        ...
        print("\nPlease ensure client_secret9.json is in the credentials/ folder")
        return False
    ...
    try:
        ...
        print("   Port: 8089")
        print("\n[U+26A0]️ IMPORTANT: Use a DIFFERENT Google account than sets 1-8")
        ...
        print(f"\n[OK] Successfully authorized Set 9!")
        ...
        print("\n" + "="*60)
        print("SUCCESS! Set 9 is ready to use")
        print("="*60)
        return True
