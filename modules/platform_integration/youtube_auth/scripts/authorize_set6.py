#!/usr/bin/env python3
"""
Authorization script for Set 6 credentials
...
print('Authorizing Set 6 credentials...')
print('=' * 50)
...
try:
    ...
    if response.get('items'):
        ...
        print()
        print('[OK] SUCCESS! Set 6 authorized!')
        print(f'[TV] Connected as: {channel}')
        print(f'[SAVE] Token saved to: {token_path}')
        print('[QUOTA] Fresh 10,000 quota units now available for Set 6!')
        print()
        print('Set 6 will be prioritized in rotation!')
    else:
    ...
    if 'invalid_client' in str(e):
        print('The client_secret6.json file might be invalid.')
