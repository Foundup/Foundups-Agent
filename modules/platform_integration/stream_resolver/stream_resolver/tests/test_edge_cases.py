...
class TestStreamResolverEdgeCases(unittest.TestCase):
    ...
    def test_search_livestreams_max_retries_quota_exceeded(self, mock_sleep):
        ...
        with patch('modules.platform_integration.stream_resolver.stream_resolver.src.stream_resolver.MAX_RETRIES', 0):
    ...
    def test_get_active_livestream_video_id_with_exception(self, mock_check_details, mock_search, mock_sleep):
        ...
        with patch('modules.platform_integration.stream_resolver.stream_resolver.src.stream_resolver.MAX_CONSECUTIVE_FAILURES', 2):
