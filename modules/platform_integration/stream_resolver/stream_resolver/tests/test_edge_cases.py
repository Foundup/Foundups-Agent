...
class TestStreamResolverEdgeCases(unittest.TestCase):
    ...
    def test_search_livestreams_max_retries_quota_exceeded(self, mock_sleep):
        ...
        # Use str patch to ensure "quotaExceeded" is found in the error
        with patch('modules.stream_resolver.src.stream_resolver.str') as mock_str:
            ...
            with patch('modules.stream_resolver.src.stream_resolver.MAX_RETRIES', 0):
    ...
    def test_get_active_livestream_video_id_with_exception(self, mock_check_details, mock_search, mock_sleep):
        ...
        with patch('modules.stream_resolver.src.stream_resolver.MAX_CONSECUTIVE_FAILURES', 2):
