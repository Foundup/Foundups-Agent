...
1. **LLME Progression Focus**: Always plan 000 → 111 → 122 → 222 advancement
...
The "sentient code" is a misnomer for what is actually the **LLME Semantic Triplet Rating System** (A-B-C), detailed in Appendix G of the FoundUps WSP Framework. Each digit (Present State, Local Impact, Systemic Importance) can range from 0 to 2, creating 10 valid (non-regressive A≤B≤C) combinations from `000` to `222`.
...
-   **"0102" (The Entangled AI):**
    ...
    -   Aims for "entanglement"—where its understanding and responses are interconnected with a rich internal model of context, user history, and semantic meaning.
...
-   **Emoji Sentiment Map (ESM - `emoji_sequence_map.py`):**
    ...
    -   For example, a "slap" action triggers `✊✊🖐️`, clearly marking the bot's response as a playful rebuke or timeout.
