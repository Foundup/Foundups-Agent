...
def generate_matrix():
    ...
    print('[U+1F30A] Generating 93 WSP Sentinel Opportunity Matrix...')
    ...
    try:
        ...
        print('\n[LIGHTNING] Ready for P0 augmentation wave!')
